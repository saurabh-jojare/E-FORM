            ...
            try
            {
                using (var dbContext = new EformEntities())
                {
                    ...
                    if (userMaster.DefaultRoleID == 74)//Added for contractor grievance
                    {
                        ...
                        userAuthModel.UserName = objCont.CON_FIRST_NAME ;
...
// above method is authentication of user
        ...
        //        dbContext.Entry(secQuestionAnswer).State = (System.Data.Entity.EntityState)EntityState.Modified;
        ...
        public bool UpdateLogDetails()
        {
            try
            {
                using (var dbContext = new EformEntities())
                {
                    ...
                    dbContext.Entry(userLog).State = (System.Data.Entity.EntityState)EntityState.Modified;
                    dbContext.SaveChanges();
                }
